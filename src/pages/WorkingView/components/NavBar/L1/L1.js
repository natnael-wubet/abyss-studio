import styles from "./L1.module.css";
...
export default function L1({ newTabAction, playAction }) {
    ...
    <CssVarsProvider>
      <div className={styles.parent}>
        ...
        >
          ...
          <IconButton variant="outlined" color="danger" onClick={playAction}>
            <PlayArrowOutlinedIcon />
          </IconButton>{" "}
          <IconButton variant="outlined" color="danger" onClick={newTabAction}>
            <AddOutlinedIcon />
          </IconButton>
        </List>
      </div>
