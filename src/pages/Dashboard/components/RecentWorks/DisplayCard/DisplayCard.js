...
export default function DisplayCard({ object, index }) {
  return (
    <>
      <div className={styles.parent}>
        ...
        >
              ...
              <Box>
                ...
                >
                  <Typography
                    level="h2"
                    noWrap
                    sx={{ color: "#fff", width: "100%", fontSize: "lg" }}
                  >
                    <Link
                      href="/projectview"
                      overlay
                      onClick={() => {
                        localStorage.currentProject = object.id;
                      }}
                      underline="none"
                      sx={{
                        color: "#fff",
          ...
          <Box sx={{ display: "flex", gap: 1, mt: 1.5, alignItems: "center" }}>
            <Avatar size="sm" sx={{ "--Avatar-size": "1.5rem" }}>
              {index}
            </Avatar>
